...
[dqw, dqx, dqy, dqz] = quatmul_delta_pandas(main_odometry,
                                            main_odometry.shift())
...
[dqw, dqx, dqy, dqz] = quatmul_delta_pandas(front_odometry,
                                            front_odometry.shift())
front_odometry['dqw'] = dqw
front_odometry['dqx'] = dqx
front_odometry['dqy'] = dqy
front_odometry['dqz'] = dqz

[dqw, dqx, dqy, dqz] = quatmul_delta_pandas(rear_odometry,
                                            rear_odometry.shift())
...
(main_aligned, front_aligned) = main_odometry.align(front_odometry,
                                                    join='inner')
print(main_aligned)
